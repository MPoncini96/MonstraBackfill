# =============================================================================
# LEGACY SNAPSHOT — beta1_legacy_shared.py
# =============================================================================
# This file is a preserved copy of beta1_shared.py as it existed BEFORE the
...
# Future Beta1 development must target beta1_shared.py, NOT this file.
...
def download_weekly_close(
    ...
    raw = get_daily_bars(tickers, start, end, adjusted=True)

    if raw.empty:
        raise ValueError("No data downloaded from market data provider.")
...
def run_beta1_reconstruction(
    ...
    # Beta1 is path-dependent, so live and backfill must replay from the same
